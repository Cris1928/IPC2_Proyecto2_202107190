...
#C:\Users\USER\Downloads\prueba2.xml
     ...
     #                           print(busqueda2.nombrepuntoservicio)
                 ...
                 #                   print("el punto es:",busqueda2.nombrepuntoservicio)
                                    busqueda2.listadoclientes.append(NodoListadoClientesD(actualcli.dpi,actualcli.nombre,0))
 ...
 #                                           print(a.idTransaccion)
  ...
  #                                      print(" cambio ")
            ...
            if int(listaempresa.returnTamano()) != 0:
                ...
                ee=listaempresa.retornarempresaconPuntode(decision)
             #   b1=listaempresa.retornarempresaconPuntode(decision)
      ...
      #          print(" ")
            ...
            while verificador2 == True:
                ...
                if decisionPatencion==1:
                    ...
                    print("tiempo promedio de atencion: "+str(b.tiempopromedioatencion())+" minutos")
                    print("tiempo maximo de atencion: "+str(b.tiempomaximoatencion())+" minutos")
                    print("tiempo minimo de atencion: "+str(b.tiempominimoatencion())+" minutos")
                    print("timpo promedio de espera: "+str(b.tiempopromediodeespera())+" minutos")
                    print("tiempo maximo de espera: "+str(b.tiempomaximoespera())+" minutos")
                    print("timepo minimo de espera: "+str(b.tiempominimoespera())+" minutos")

                    b.graficar()
                    print("\t \t \t ESCRITORIO DE SERVICIO ACTIVO \t \t \t")
                    b.comportamientoatencion()
                    
                   # b.primero.listaEsc.primero
                    #while b is not None:
            ...
            #DEBO VALIDAR QUE EL TAMAÑO DE ACTIVOS E INACTIVOS NO SEA 0 !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1
             #       b2.Escritoriosinactivos() 
                 ...
                 #  cambiarestado=int(input("ingrese el escritorio que desea cambiar de estado: "))
                   b2.reevaluaresc(int(b2.CantidaddeEstadosInactivos()))
                  ...
                  # cambiarestad2=int(input("ingrese el escritorio que desea cambiar de estado: "))
                    b2.reevaluaresc2(int(b2.CantidaddeEstados()))
                elif decisionPatencion ==4:
                    b.atenderprueba()

                   # print(b.cantidaddetrans())
                elif decisionPatencion==5:
                    dpi=str(input("ingrese el dpi de el cliente: "))
                    nombrecliente=str(input("ingrese el nombre del cliente: "))
                    b.agregarcliente(dpi,nombrecliente)
                    cuantastransacciones=int(input("ingrese el numero de transacciones que desea: "))
                    contadorq=0
                    while contadorq != cuantastransacciones:
                        id=str(input("ingrese el id de la transaccion: "))
                       # nomb=str(input("ingrese el nombre de la transaccion: "))
                        cantidad=int(input("ingrese la cantidad que se realizara de dicha trasaccion: "))
                        nomb=ee.ListaTransiccion.buscarTrans(id)
                        #tiempo=int(input("ingrese la cantidad de tiempo de la transaccion: "))
                       # bus=b.buscarcliente(dpi)
                        b.agregarletrasacciones(dpi,id,nomb.nombreTransaccion,cantidad,nomb.minutosAtencion)
                      #  bus.listaTransacciones.append(dpi,id,nomb.nombreTransaccion,cantidad,nomb.minutosAtencion)
                ...
                elif decisionPatencion==6:
                    if int(b2.CantidaddeEstados()) >0:
                        b.atender1()
                        print(" ")
                        print(" ")
                       # print("cantidad de escritorios activos: ",b2.CantidaddeEstados())
                ...
                elif decisionPatencion==7:
                    verificador2=False
#C:\Users\USER\Downloads\prueba1.xml            C:\Users\USER\Downloads\ConfigSys.xml
#C:\Users\USER\Downloads\prueba2.xml            C:\Users\USER\Downloads\ConfigInit.xml
